...
// Verificar se elementos existem antes de inicializar modais
let cadastrarModal = null;
let visualizarModal = null;

if(document.getElementById("cadastrarModal")) {
    cadastrarModal = new bootstrap.Modal(document.getElementById("cadastrarModal"));
}

if(document.getElementById("visualizarModal")) {
...
function carregarEventos() {
  ...
  //const pesq_events = inputClienteId.getAttribute('data-target-pesq-events');
    ...
    // Verificar se o elemento external-events-list existe
    if (containerEl) {
...
,
      ...
      eventClick: function (event) {
       ...
       // Abrir a janela modal visualizar se existir
       if(visualizarModal) {
      ...
      select:  function (event) {
        ...
        // Abrir a janela modal cadastrar se existir
        if(cadastrarModal) {
            cadastrarModal.show();
        }
      },
