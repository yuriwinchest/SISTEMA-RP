	...
	<div id="header" >
		...
		<table id="cabecalhotabela" style="font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			<thead>
				...
				<tr >
					<td style="width:7%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><?php echo @@mb_strtoupper($defeito_os) ?>: </td>
				...
				<tr>
					<td style="width:11%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><?php echo @@mb_strtoupper($acessorios_os) ?>: </td>
					<td style="width:100%; border-bottom: 1px solid #000;">
				...
				<tr>
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><?php echo @@mb_strtoupper($avarias_os) ?>: </td>
					<td style="width:100%; border-bottom: 1px solid #000;">
						<?php echo @@mb_strtoupper($condicoes) ?>
					</td>
				</tr>
				<tr>
					<td style="width:14%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><?php echo @@mb_strtoupper($laudo_os) ?>: </td>
					<td style="width:100%; border-bottom: 1px solid #000;">
				...
				<tr>
					...
					<?php if($senha_ap != ""){ ?>
						<td style="width:18%; border-right: 1px solid #000;border-bottom: : 1px solid #000;"><?php echo @@mb_strtoupper($senha_aparelho_os) ?>: </td>
					<td style="width:100%; border-bottom: : 1px solid #000;">
		...
		<div style="background:#f2f0f0; padding:5px; margin-top: 20px;">
			...
			<?php if($mao_obra > 0){ ?>
				<div align="right" style="margin-top: 4px; font-size:10px;">
					<span><b><?php echo @@mb_strtoupper($mao_obra_os) ?>:</b> R$ <?php echo $mao_obraF ?></span>
				</div>
			<?php } ?>
