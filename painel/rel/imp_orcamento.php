...
$nome_produto = $res2[0]['nome'];
 ?>
 		...
 		<tr style="font-size: 12px">
			...
			<td colspan="2" width="65%"> <?php echo $quantidade ?> - <?php echo $nome_produto ?></td>				
	...
	<tfoot>
		...
		<?php if($mao_obra > 0){ ?>
			<tr style="font-size: 12px">
				<td colspan="2">Total <?php echo $mao_obra_orc ?></td>
		...
		<tr style="font-size: 12px">
			...
			<td align="right" v>R$ <?php echo $freteF ?></td>
		</tr>
		<?php } ?>
		...
		<tr style="margin-top:2px; font-size: 12px; text-align:center">
			<td colspan="3"><b><?php echo @mb_strtoupper($defeito_orc) ?>:</b> <?php echo $defeito ?></td>
		...
		<tr style="margin-top:2px; font-size: 12px; text-align:center">
			<td colspan="3"><b><?php echo @mb_strtoupper($acessorios_orc) ?>:</b> <?php echo $acessorios ?></td>
		...
		<tr style="margin-top:2px; font-size: 12px; text-align:center">
			<td colspan="3"><b><?php echo @mb_strtoupper($avarias_orc) ?>:</b> <?php echo $condicoes ?></td>
		...
		<tr style="margin-top:2px; font-size: 12px; text-align:center">
			<td colspan="3"><b><?php echo @mb_strtoupper($laudo_orc) ?>:</b> <?php echo $laudo ?></td>
...
<!-- Campo senha -->
	<tr style="margin-top:2px; font-size: 12px; text-align:center">
			<td colspan="3"><small><b><?php echo @mb_strtoupper($senha_aparelho_orc) ?>:</b>
