...
if($status == 'Hoje'){
	...
	$query = $pdo->query("SELECT * from $pagina WHERE data >= '$dataInicial' and data <= '$dataFinal' and status = '$status' and empresa = '$id_empresa' order by id desc ");
}
...
HTML;
	...
	echo 'Não possui nenhuma Ordem de Serviço '.$status.' nesta Data!';
}
