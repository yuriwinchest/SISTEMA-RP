...
if($id == ""){
	$query = $pdo->prepare("INSERT INTO $tabela SET descricao = :descricao, fornecedor = '$fornecedor', valor = :valor, vencimento = '$data_venc', data_lanc = curDate(), usuario_lanc = '$id_usuario', arquivo = '$foto', pago = '$pago', funcionario = '0', obs = :obs, referencia = 'Compra', id_ref = '$produto', data_pgto = '$data_pgto', quantidade = '$quantidade', forma_pgto = '$saida', usuario_pgto = '$id_usuario', empresa = '$id_empresa', hora_alerta = '$hora_random'");	
