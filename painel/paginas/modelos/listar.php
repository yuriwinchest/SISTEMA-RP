...
<td style="color:{$classe_ativo}">{$noem_equipamento}</td>
<td style="color:{$classe_ativo}">{$nome_marca}</td>

<td>
	<a class="btn btn-info btn-sm" href="#" onclick="editar('{$id}','{$nome}','{$marca}','{$equipamento}')" title="Editar Dados"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
	function editar(id, nome, marca, equipamento){
		$('#mensagem').text('');
