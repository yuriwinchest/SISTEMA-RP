...
<div class="justify-content-between" style="margin-top: 20px">
	<div class="left-content mt-2 mb-3">
		<form action="rel/caixas_class.php" method="post" target="_blank">
			...
			<div class="esc ocultar_mobile" style="float:left; margin-right:10px"><span><small><i title="Data Inicial"
							class="fa fa-calendar-o"></i></small></span>
			...
			<div class="esc ocultar_mobile" style="float:left; margin-right:10px"><span><small><i title="Data  Final"
			...
			<select class="form-select sel50"  name="operador" id="status-busca" style="width:350px" onchange="buscar()">
				...
				if ($nivel_usuario == 'Administrador' || $nivel_usuario == 'Gerente') {
					$query = $pdo->query("SELECT * FROM usuarios where nivel != 'Cliente' and acessar_painel != 'Não' order by id desc");
