...
<div class="mt-4 justify-content-between">
	...
	<?php if($tem_debito > 0){ ?>
		<div style="background: #ffc341; color:#3e3e3e; padding:10px; font-size:14px; margin-bottom:10px; font-weight: 500">
			<div><i class="fa fa-info-circle"></i> <b>Aviso: </b> Prezado Cliente, não identificamos o pagamento de sua última
				...
				acesso ao sistema será desativado, <a href="mensalidades" style="color:blue">Clique Aqui</a> para ver seus débitos.</div>
		</div>
	<?php } ?>
	...
	<div class="row">
		<div class="col-xl-3 col-lg-12 col-md-6 col-xs-12 <?php echo @$orcamentos_rec ?>">
			<div class="card sales-card"
				style="box-shadow: 2px 2px 0px 0px rgba(0, 0, 0, 0.1); height:130px; border-radius: 10px;">
				<a href="orcamentos">
					<div class="row">
						<div class="col-8">
							<div class="ps-4 pt-4 pe-3 pb-4">
								<div class="">
									<p class="mb-1" style="">Orçamento Pendente</p>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<h4 class="tx-20 font-weight-semibold mb-2"><?php echo $orc_pendentes ?></h4>
									</div>
									<p class="mb-0 tx-12 text-muted">Pendentes Mês<i class="fa fa-caret-up mx-1 text-dark"></i>
										<span class="text-dark tx-11"><?php echo $orc_pendentes_mes ?></span>
									</p>
								</div>
							</div>
						</div>
						<div class="col-4">
							<div class=" zoom circle-icon iconBgRoxo text-center align-self-center overflow-hidden ">
								<i class="fe fe-file tx-16 text-white"></i>
							</div>
						</div>
					</div>
				</a>
				...
				<a href="orcamento">
					<div class="row">
						<div class="col-8">
							<div class="ps-4 pt-4 pe-3 pb-4">
								<div class="">
									<p class=" mb-1">Orçamento Concluído</p>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<h4 class="tx-20 font-weight-semibold mb-2"><?php echo $orcamentos_concluidos ?></h4>
									</div>
									<p class="mb-0 tx-12 text-muted">Concluídos no Mês<i class="fa fa-caret-up mx-1 text-dark"></i>
										<span class="text-dark tx-11"><?php echo $orcamentos_concluidos_mes ?></span>
									</p>
								</div>
							</div>
						</div>
		...
		<div class="col-xl-3 col-lg-12 col-md-6 col-xs-12 <?php echo @$os_rec ?>">
			<div class="card sales-card"
				style="box-shadow: 2px 2px 0px 0px rgba(0, 0, 0, 0.1); height:130px; border-radius: 10px">
				<a href="os">
					<div class="row">
						<div class="col-8">
							<div class="ps-4 pt-4 pe-3 pb-4">
								<div class="">
									<p class=" mb-1">OS Abertas</p>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<h4 class="tx-20 font-weight-semibold mb-2"><?php echo $os_pendentes ?></h4>
									</div>
									<p class="mb-0 tx-12 text-muted">Abertas Mês<i class="fa fa-caret-down mx-1 text-dark"></i>
										<span class="text-dark tx-11"><?php echo $os_pendentes_mes ?></span>
									</p>
								</div>
							</div>
						</div>
						<div class="col-4">
							<div class="zoom circle-icon iconBgDanger text-center align-self-center overflow-hidden">
								<i class="bi bi-file-pdf tx-16 text-white"></i>
							</div>
						</div>
					</div>
				</a>
				...
				<a href="os">
					<div class="row">
						<div class="col-8">
							<div class="ps-4 pt-4 pe-3 pb-4">
								<div class="">
									<p class=" mb-1">OS Finalizadas</p>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<h4 class="tx-20 font-weight-semibold mb-2"><?php echo $os_finalizadas ?></h4>
									</div>
									<p class="mb-0 tx-12 text-muted">OS Finalizadas Mês<i class="fa fa-caret-up mx-1 text-dark"></i>
										<span class="text-dark tx-11"><?php echo $os_finalizadas_mes ?></span>
									</p>
								</div>
							</div>
						</div>
		...
		<div class="card sales-card" style="box-shadow: 2px 2px 0px 0px rgba(0, 0, 0, 0.1);">
			<div class="row">
				<div class="col-8">
					<div class="ps-4 pt-4 pe-3 pb-4">
						<div class="">
							<h6 class="mb-2 tx-12">Vendas Hoje</h6>
						</div>
						<div class="pb-0 mt-0">
							<div class="d-flex">
								<h4 class="tx-20 font-weight-semibold mb-2 text-success">R$ <?php echo $vendas_hojeF ?></h4>
							</div>
							<p class="mb-0 tx-12 text-muted">Vendas Mês<i class="fa fa-caret-up mx-2 text-success"></i>
								<span class="font-weight-semibold text-success">R$ <?php echo $vendas_mesF ?></span>
							</p>
						</div>
					</div>
				</div>
