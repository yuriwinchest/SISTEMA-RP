...
$query = $pdo->query("SELECT * from $pagina WHERE status = 'Pendente' and empresa = '$id_empresa' order by id asc ");
...
echo <<<HTML
	...
	<br>
	<div align="right"><span>Total Pendentes: <span class="text-danger">{$total_pendentesF}</span></span> </div>
</small>
HTML;
}else{
