...
$query = $pdo->query("SELECT * from $pagina where status = 'Aprovado' and empresa = '$id_empresa'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$total_orcamentos = @count($res);


$query = $pdo->query("SELECT * from $pagina WHERE status = 'Aprovado' and empresa = '$id_empresa' order by id asc ");
...
echo <<<HTML
	...
	<br>
	<div align="right"><span>Total Aprovados: <span class="" style="color:green">R$ {$total_pagoF}</span></span> </div>
</small>
HTML;
}else{
