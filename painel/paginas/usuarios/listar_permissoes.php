...
$total_reg = @count($res);
if($total_reg > 0){
	echo '<span class="titulo-grupo" style="font-weight:500"><b>SEM GRUPO</b></span><br><div class="row" style="padding-left:15px; padding-top:5px">';
	...
	for($i=0; $i < $total_reg; $i++){
		...
		<label class="labelcheck" style="font-size:12px;">
		'.$nome.'
		</label>
		</div>
		';
...
if($total_reg3 > 0){
	echo '<span class="titulo-grupo" style="font-weight:500"><b>'.mb_strtoupper($nome).'</b></span><br><div class="row" style="padding-left:15px; padding-top:5px">';
