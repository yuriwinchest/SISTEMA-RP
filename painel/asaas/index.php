...
if(@$taxa_cartao_api > 0){
    ...
    $total_com_taxa = $total + ($total * ($taxa_cartao_api / 100));  
    $valor_da_taxa = $total * ($taxa_cartao_api / 100);    
...
<div class="checkout-container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="order-summary">
                ...
                <?php if($valor_da_taxa > 0 and $ATIVAR_CARTAO_CREDITO == 1){ ?>
                    <div class="summary-item" style="font-size: 12px">
                    <span>Taxa Pagamento no Cartão</span>
                    <span>R$ <?php echo number_format($valor_da_taxa, 2, ',', '.');?></span>
                </div>
                <?php } ?>
    ...
    <div class="payment-methods accordion" id="accordionPayment">
        ...
        <!-- Cartão de crédito -->
        <?php if ($ATIVAR_CARTAO_CREDITO == "1") { ?>
