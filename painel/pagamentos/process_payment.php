...
try {
    ...
    // Guarda o id_conta para uso interno (seu sistema)
$id_conta = $parsed_body['id_conta'] ?? null;

// Remove do payload antes de mandar para o Mercado Pago
unset($parsed_body['id_conta']);
