...
<div class="justify-content-between" style="margin-top: 20px">
	<div class="left-content mt-2 mb-3">
		<form action="rel/caixas_class.php" method="post" target="_blank">
			...
			<select class="form-select sel50"  name="operador" id="status-busca" style="width:350px" onchange="buscar()">
						<?php
				if ($nivel_usuario == 'Administrador' || $nivel_usuario == 'Gerente') {
					$query = $pdo->query("SELECT * FROM usuarios where nivel != 'Cliente' and acessar_painel != 'Não' and (empresa = 0 or empresa is null) order by id desc");
					echo '<option value="">Selecionar Operador</option>';
				} else {
					$query = $pdo->query("SELECT * FROM usuarios where id = '$id_usuario' and (empresa = 0 or empresa is null) ");
				}
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-5">
							<div class="form-group">
								...
								<select class="form-select sel5" aria-label="Default select example" name="operador" id="operador" style="width:100%" required>
									<?php
									if ($nivel_usuario == 'Administrador' || $nivel_usuario == 'Gerente') {
										$query = $pdo->query("SELECT * FROM usuarios where nivel != 'Cliente' and (empresa = 0 or empresa is null) order by id desc");
										echo '<option value="">Selecionar Operador</option>';
									} else {
										$query = $pdo->query("SELECT * FROM usuarios where id = '$id_usuario' and (empresa = 0 or empresa is null) ");
									}
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="valor_abertura" id="valor_abertura" onKeyup="mascaraMoeda(this)" required>
								</div>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="row">
						...
						<div class="col-md-2" style="margin-top: 25px">
							<button type="submit" class="btn btn-primary">Salvar<i class="fa fa-check ms-2"></i>
							</button>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="total_caixa_fechar" id="total_caixa_fechar" onKeyup="mascaraMoeda(this)" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="valor_sangria" id="valor_sangria" value="0,00" onKeyup="mascaraMoeda(this)" placeholder="0,00">
									</div>
							</div>
						</div>
